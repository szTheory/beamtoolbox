...
- Authentication, OAuth 2.0 [[ex]](https://hex.pm/packages/oauth2)
- Authentication, OAuth 2.0 (multi-provider) [[ex]](https://hex.pm/packages/assent)
- Authentication, OAuth 2.0 (Google Cloud Service only) [[ex]](https://hex.pm/packages/goth)
...
- Authentication, OpenID Connect, Cowboy handler [[erl]](https://hex.pm/packages/oidcc_cowboy)
...
- Property-based testing (pure Elixir) [[ex]](https://hex.pm/packages/stream_data) [[ex]](https://hex.pm/packages/quixir)
...
- UUID generator [[ex]](https://hex.pm/packages/uuid) [[ex]](https://hex.pm/packages/elixir_uuid) [[erl]](https://hex.pm/packages/uuid_erl)
