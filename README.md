...
- Authentication framework [[ex]](https://hex.pm/packages/guardian)
- Authentication, Multi-provider/OAuth2 [[ex]](https://hex.pm/packages/assent)
- Authorization middleware for Absinthe GraphQL [[ex]](https://hex.pm/packages/speakeasy)
...
- Base64 encode/decode [[ex]](https://hex.pm/packages/base64url) [[ex]](https://hex.pm/packages/image64)
- Base64, fast with C NIF [[erl]](https://hex.pm/packages/b64fast)
