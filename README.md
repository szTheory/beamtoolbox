...
- Cassandra database driver [[ex]](https://hex.pm/packages/xandra) [[ex]](https://hex.pm/packages/cassandra)
...
- Kafka client [[ex]](https://hex.pm/packages/kafka_ex) [[erl]](https://hex.pm/packages/brod)
- Key/value store (ETS) [[ex]](https://hex.pm/packages/stash)
- Key/value stores unified interface [[ex]](https://hex.pm/packages/mnemonix)
- Kubernetes client [[ex]](https://hex.pm/packages/kazan) [[ex]](https://hex.pm/packages/k8s)
...
- REST API framework [[ex]](https://hex.pm/packages/maru) [[ex]](https://hex.pm/packages/placid) [[erl]](https://hex.pm/packages/rest)
- REST API framework, Swagger integration (Maru) [[ex]](https://hex.pm/packages/maru_swagger)
