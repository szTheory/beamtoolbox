...
I do not list web API clients here. There are too many of them, it's too difficult to keep up with their changes, many of them are simple to implement yourself as HTTP calls to the REST API, and you can simply search on https://hex.pm/ to find ones relevant to the API in question.
