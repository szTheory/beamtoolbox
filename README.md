...
- IoT framework [[ex]](https://github.com/astarte-platform/astarte) [[erl]](https://hex.pm/packages/grisp)
...
- JSON encoder/decoder [[ex]](https://hex.pm/packages/jason)  [[erl]](https://hex.pm/packages/jiffy) [[erl]](https://hex.pm/packages/jsx) [[erl]](https://github.com/lordnull/rec2json)
- JSON testing helpers [[ex]](https://hex.pm/packages/test_that_json)
- JSON validation [[ex]](https://github.com/danmcclain/voorhees) [[erl]](https://github.com/patternmatched/ejsv)
