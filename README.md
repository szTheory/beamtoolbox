...
- IoT framework [[ex]](https://github.com/astarte-platform/astarte)
...
- MySQL database driver [[ex]](https://hex.pm/packages/myxql) [[erl]](https://hex.pm/packages/mysql)
...
- Rate-limiter [[ex]](https://hex.pm/packages/hammer) [[ex]](https://hex.pm/packages/ratekeeper) [[ex]](https://hex.pm/packages/ex_rated) [[erl]](https://hex.pm/packages/ratx)
...
- Static site generator, blog engine [[ex]](https://hex.pm/packages/blogit) [[ex]](https://hex.pm/packages/archivist)
...
- Worker process pooling [[erl]](https://hex.pm/packages/poolboy) [[erl]](https://hex.pm/packages/pooler) [[erl]](https://hex.pm/packages/worker_pool)
