...
- Swagger API documentation generator [[ex]](https://hex.pm/packages/xcribe)
...
- XML encode [[ex]](https://hex.pm/packages/elixir_map_to_xml)
...
- Absinthe scaffold generator [[ex]](https://hex.pm/packages/absinthe_gen)
