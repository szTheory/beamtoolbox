...
- Document driven development (Swagger/OpenAPI) [[ex]](https://hex.pm/packages/apocryphal)
...
- JSON encoder/decoder [[ex]](https://hex.pm/packages/jason)  [[erl]](https://hex.pm/packages/jiffy) [[erl]](https://hex.pm/packages/jsx) [[erl]](https://github.com/lordnull/rec2json) [[erl]](https://hex.pm/packages/jsone)
...
- Swagger/OpenAPI documentation generator [[ex]](https://hex.pm/packages/xcribe)
...
- XML encode/decode [[erl]](https://hex.pm/packages/fast_xml)
...
- Rebar release upgrades [[erl]](https://hex.pm/packages/rebar3_appup_plugin)
