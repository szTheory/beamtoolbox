...
- 2D/3D math [[ex]](htts://hex.pm/packages/graphmath)
- A* pathfinding algorithm [[ex]](htts://hex.pm/packages/eastar)
- ABNF grammar parser [[ex]](htts://hex.pm/packages/ex_abnf)
- Address parsing (US) [[ex]](htts://hex.pm/packages/address_us)
- Anaphora macros [[ex]](htts://hex.pm/packages/anaphora)
- Apache Druid real-time analytics database client [[ex]](htts://hex.pm/packages/panoramix)
- Apache httpasswd file reader/writer [[ex]](htts://github.com/kevinmontuori/Apache.htpasswd)
- Apache Thrift service framework bindings [[ex]](htts://github.com/pinterest/riffed) [[erl]](https://thrift.apache.org/lib/erl)
- Apache Tinkerpop/Gremlin client [[ex]](htts://hex.pm/packages/gremlex)
- API authentication (simple key/secret) [[ex]](htts://hex.pm/packages/signaturex)
- API auto generator [[ex]](htts://hex.pm/packages/apix)
- API gateway framework [[ex]](htts://hex.pm/packages/rackla)
- API pagination headers (RFC-5988) [[ex]](htts://hex.pm/packages/scrivener)
- API testing [[erl]](https://github.com/for-GET/katt)
- Arbitrary precision decimal arithmetic [[ex]](htts://hex.pm/packages/decimal)
- Articles extract/curate [[ex]](htts://hex.pm/packages/readability)
- ASCII tables [[ex]](htts://hex.pm/packages/table_rex)
- ATOM feed builder (RFC4287) [[ex]](htts://hex.pm/packages/atomex)
- Authentication, non-Plug apps [[ex]](htts://hex.pm/packages/guardian)
- Authorization for Absinthe GraphQL [[ex]](htts://hex.pm/packages/speakeasy)
- Authorization, rule based [[ex]](htts://hex.pm/packages/authorize)
- AWS Signature V4 [[ex]](htts://hex.pm/packages/sigaws) [[ex]](https://hex.pm/packages/aws_auth)
- Background jobs queue (Disque) [[ex]](htts://hex.pm/packages/exdisque)
- Background jobs queue (iCloud) [[ex]](htts://hex.pm/packages/cloudi_core)
- Background jobs queue (Mnesia) [[ex]](htts://hex.pm/packages/que)
- Background jobs queue (PostgreSQL) [[ex]](htts://hex.pm/packages/oban) [[ex]](https://hex.pm/packages/rihanna)
- Background jobs queue (RabbitMQ) [[ex]](htts://hex.pm/packages/task_bunny)
- Background jobs queue (Redis) [[ex]](htts://hex.pm/packages/verk)
- Background jobs queue (Resque/Sidekiq) [[ex]](htts://hex.pm/packages/exq)
- Background jobs queue, transactional (Ecto, PostgreSQL, GenStage) [[ex]](htts://hex.pm/packages/ecto_job)
- Background jobs queue [[ex]](htts://hex.pm/packages/toniq) [[ex]](https://hex.pm/packages/verk)
- Barrel-db distributed document database client [[ex]](htts://github.com/jxub/barrel_ex.git)
- Base conversion [[ex]](htts://hex.pm/packages/convertat) [[ex]](https://hex.pm/packages/custom_base)
- Base58 encoding/decoding for Elixir [[ex]](htts://hex.pm/packages/base58) [[ex]](https://hex.pm/packages/base58check)
- Base62 encoder/decoder [[ex]](htts://hex.pm/packages/base62)
- Base64 images encode/decode [[ex]](htts://hex.pm/packages/image64)
- Batch message passing between Erlang/Elixir nodes [[ex]](htts://hex.pm/packages/manifold)
- Bayes/Naive Bayes algorithm [[ex]](htts://hex.pm/packages/simple_bayes)
- Beanstalkd client [[ex]](htts://hex.pm/packages/elixir_talk)
...
- Cluster automatic formation/healing [[ex]](https://hex.pm/packages/libcluster)
...
- Code reloader [[ex]](https://hex.pm/packages/exsync)
...
- Command Query Responsibility Segregation (CQRS) [[ex]](https://hex.pm/packages/commanded)
...
- CQRS EventStore client (PostgreSQL) [[ex]](https://hex.pm/packages/eventstore)
...
- EUnit Mix task helper [[ex]](https://hex.pm/packages/mix_eunit)
- Event bus bridge to Vert.x services (TCP) [[ex]](https://hex.pm/packages/ex_vertx)
...
- Fast, simple and lightweight pagination system for your Elixir application [[ex]](https://hex.pm/packages/turn_the_page)
...
- Helpers built to work with Scrivener's page struct to easily build HTML output for various CSS frameworks [[ex]](https://hex.pm/packages/scrivener_html)
...
- React server-side rendering (SSR) [[ex]](https://hex.pm/packages/reaxt)
...
- Rethinkdb client (JSON) [[ex]](https://hex.pm/packages/rethinkdb) [[erlang]](https://hex.pm/packages/erlang_rethinkdb)
...
- Test mocks [[ex]](https://hex.pm/packages/mox) [[ex]](https://hex.pm/packages/mockery) [[ex]](https://hex.pm/packages/mock) [[ex]](https://hex.pm/packages/hammox) [[erl]](https://hex.pm/packages/meck)
...
- Authentication/OAuth2 [[ex]](https://hex.pm/packages/ueberauth)
...
- Admin scaffolds [[ex]](https://hex.pm/packages/torch)
...
- GeoNames API client [[ex]](https://hex.pm/packages/geonames) [[erlang]](https://hex.pm/packages/egeonames)
...
- Logging client (Fluentd) [[ex]](https://hex.pm/packages/fluent_client) [[erlang]](https://hex.pm/packages/efluentc)
...
- Code formatter [[erl]](https://hex.pm/packages/steamroller) [[erl]](https://hex.pm/packages/rebar3_format)
...
- Tag a second alternative with [[ex]](https://link-to-runner-up.com)
